...
latex_documents = [
    (master_doc, 'lfd.tex', 'lfd Documentation',
     'Dino Bektesevic', 'manual'),
]
...
man_pages = [
    (master_doc, 'lfd', 'lfd Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'lfd', 'lfd Documentation',
     author, 'lfd', 'One line description of project.',
     'Miscellaneous'),
]
